    ...
    get 'Retrieves a Comment' do
      ...
      response '200', 'Comment found' do
        schema type: :object,
               ...
               required: %w[id user_id post_id content created_at updated_at]

        let(:id) do
          Comment.create(id: 2, user_id: 1, post_id: 1, content: 'sdsds', created_at: '2021-12-15 12:25:17.388417000',
                         updated_at: '2021-12-15 12:25:17.388417000').id
        end
        run_test!
      end
